...
public class Level3Fragment extends Fragment implements View.OnTouchListener{
    ...
    private void setViewData() {
        ...
        mBinding.imageBack21.setImageResource(list.get(4));
        mBinding.imageBack22.setImageResource(list.get(5));
        mBinding.imageBack23.setImageResource(list.get(6));
        mBinding.imageBack24.setImageResource(list.get(7));
        mBinding.imageBack31.setImageResource(list.get(8));
        mBinding.imageBack32.setImageResource(list.get(9));
        mBinding.imageBack33.setImageResource(list.get(10));
        mBinding.imageBack34.setImageResource(list.get(11));
        mBinding.imageBack41.setImageResource(list.get(12));
        mBinding.imageBack42.setImageResource(list.get(13));
        mBinding.imageBack43.setImageResource(list.get(14));
        mBinding.imageBack44.setImageResource(list.get(15));

package tqani.apps.obg.animation;
...
/**
 * Created by d1jun on 2018-02-24.
 */
...
public class Rotate3DAnimation extends Animation{
    ...
    public Rotate3DAnimation(float mFromDegress, float mToDegress, float mCenterX, float mCenterY, float mDepthZ, boolean mReverse) {
